const translations = {
    vi: {
        ...
        "pro.manage_title": "Quản lý Gói Đăng ký",
        "pro.current_plan": "Gói hiện tại",
        "pro.auto_renew": "Tự động gia hạn",
        "pro.no_auto_renew": "Không gia hạn",
        "pro.auto_renew_cancelled": "Sắp hết hạn (Đã hủy)",
        "pro.until_date": "Đến ngày",
        "pro.days_left": "Còn lại",
        "pro.days_unit": " ngày",
        "pro.expired": "Đã hết hạn",
        "pro.options": "Tùy chọn",
        "pro.upgrade_yearly": "Nâng lên Gói Năm &mdash; Chỉ 849,000 VNĐ (Tiết kiệm ~30%)",
        "pro.disable_auto_renew": "Tắt tự động gia hạn",
        "pro.enable_auto_renew": "Bật tự động gia hạn",
        "pro.cancel_sub": "Hủy đăng ký (Vẫn dùng được đến hết hạn)",
        "pro.expire_warning": "Khi hết hạn mà không gia hạn, tài khoản sẽ tự về bản Free. Dữ liệu vượt quá giới hạn 5 phòng/5 hóa đơn/tháng sẽ tạm thời bị khóa cho đến khi gia hạn.",
    ...
    en: {
        ...
        "pro.current_plan": "Current Plan",
        "pro.auto_renew": "Auto-renew",
        "pro.no_auto_renew": "No auto-renew",
        "pro.auto_renew_cancelled": "Expiring (Cancelled)",
        "pro.until_date": "Until Date",
        "pro.days_left": "Days Left",
        "pro.days_unit": " days",
        "pro.expired": "Expired",
        "pro.options": "Options",
        "pro.upgrade_yearly": "Upgrade to Yearly &mdash; Only 849,000 VND (Save ~30%)",
        "pro.disable_auto_renew": "Disable auto-renew",
        "pro.enable_auto_renew": "Enable auto-renew",
        "pro.cancel_sub": "Cancel subscription (Active until expiration)",
        "pro.expire_warning": "If not renewed before expiration, the account will revert to the Free plan. Data exceeding the 5 rooms/5 bills per month limit will be temporarily locked.",
